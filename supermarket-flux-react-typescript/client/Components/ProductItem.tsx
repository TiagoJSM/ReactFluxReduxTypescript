            ...
            <div className="product col-xs-12 col-sm-12 col-md-12">
                ...
                <div className="row">
                    ...
                    <div className="col-xs-12 col-sm-2 col-md-2 v-align">
                        <button type="button" className="btn btn-danger" onClick={this.handleProductDelete.bind(this) as React.EventHandler<React.FormEvent>}>
                ...
                <div className="row">
                    <div className="col-xs-6 col-sm-6 col-md-6">
                        <button type="button" className="btn btn-success" onClick={this.handleProductAddToCart.bind(this) as React.EventHandler<React.FormEvent>}>
                                ADD TO CART
                            </button>
                    </div>
                    <div className="col-xs-6 col-sm-6 col-md-6">
                        <input
                            ...
                            onChange={this.onQuantityToBuyChange.bind(this) as React.EventHandler<React.FormEvent>} />
                    </div>
                </div>
            </div>
        );
